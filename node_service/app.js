...
const client = new Eureka({
   // Eureka 서버의 설정
   eureka: {
      host: 'localhost',  // Eureka 서버의 주소
      port: 8761,  // Eureka 서버의 포트
      servicePath: '/eureka/apps/'
   },
   instance: {
      app: 'nodejs-service',  // 서비스의 이름
      hostName: 'localhost',  // 서비스의 호스트 이름
      ...
      statusPageUrl: 'http://localhost:8003',  // 서비스의 상태 페이지 URL
      healthCheckUrl: 'http://localhost:8003/health',  // 서비스의 헬스 체크 URL
      dataCenterInfo: {
