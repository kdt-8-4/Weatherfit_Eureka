...
public class JwtTokenGlobalFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if(path.equals("/comment/jwtTest") || path.equals("/board/write") || path.equals("/comment/write") || path.equals("/comment/reply") || path.startsWith("/board/like") || path.equals("/board/myList") || path.startsWith("/board/edit")) {
            try {
